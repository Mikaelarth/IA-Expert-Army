...
[![Tests](https://img.shields.io/badge/tests-387%20passing-brightgreen)](tests/unit/)
...
Voir [docs/architecture.md](docs/architecture.md) (diagrammes mermaid + état d'implémentation) et [docs/adr/](docs/adr/) pour les **13 ADRs** documentant les décisions structurantes. En cas d'incident en mode autonome : [docs/runbook.md](docs/runbook.md).
